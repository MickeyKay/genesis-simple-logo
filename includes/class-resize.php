...
/**
 * Resize images using WordPress core functions.
 *
 * Based on RG_Resize from the Rocket Galleries plugin by Matthew Ruddy.
 *
 * @author Robert Neu
 * @see    http://wordpress.org/plugins/rocket-galleries/
 */
class Genesis_Simple_Logo_Resize {

	/**
	 * Class instance
	 *
	 * @var Genesis_Simple_Logo_Resize
	 */
	 ...
	 *
	 * @return Genesis_Simple_Logo_Resize
	 */
